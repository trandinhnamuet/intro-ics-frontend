...
export default function NhaMayThongMinhPage() {
  ...
  const features = [
    {
      icon: Lightbulb,
      title: t('smartFactory.feature1.title'),
      description: t('smartFactory.feature1.desc'),
      benefit: t('smartFactory.feature1.benefit')
    },
    {
      icon: ShieldCheck,
      title: t('smartFactory.feature2.title'),
      description: t('smartFactory.feature2.desc'),
      benefit: t('smartFactory.feature2.benefit')
    },
    {
      icon: Wind,
      title: t('smartFactory.feature3.title'),
      description: t('smartFactory.feature3.desc'),
      benefit: t('smartFactory.feature3.benefit')
    },
    {
      icon: BarChart3,
      title: t('smartFactory.feature4.title'),
      description: t('smartFactory.feature4.desc'),
      benefit: t('smartFactory.feature4.benefit')
    }
  ]
  ...
  return (
    <>
            ...
            <ScrollReveal direction="left">
              <div>
                <Badge className="mb-6 px-4 py-2 bg-white/20 backdrop-blur-sm border-white/30 text-white">
                  ...
                  {t('smartFactory.badge')}
                </Badge>
                
                <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6">
                  {t('smartFactory.title')}
                </h1>
                
                <p className="text-xl text-white/90 mb-8 leading-relaxed">
                  {t('smartFactory.mainDescription')}
                </p>
                
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    size="lg" 
                    className="bg-white text-orange-600 hover:bg-white/90 font-semibold text-lg"
                  >
                    {t('common.learnMore')}
            ...
            {features.map((feature, idx) => (
              <ScrollReveal key={idx} direction="up" delay={idx * 100}>
                <Card className="p-8 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 h-full flex flex-col">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mb-6 shrink-0">
                    <feature.icon className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold mb-4">{feature.title}</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4 flex-grow">{feature.description}</p>
                  <div className="pt-4 border-t mt-auto">
                    <p className="text-sm font-semibold text-orange-600 mb-2">Lợi ích:</p>
      ...
      <Section spacing="xl" background="muted">
        <div className="container-responsive">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal direction="right">
              <Card className="p-8 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 border-2 border-amber-200 dark:border-amber-800">
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">Năng suất tăng</div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">Giảm downtime</div>
                      <div className="text-3xl font-bold text-green-600">-50%</div>
                    </div>
                    <Cog className="w-12 h-12 text-green-500" />
                  </div>
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">An toàn lao động</div>
      ...
      <Section spacing="xl" background="gradient">
        <div className="container-responsive">
          <ScrollReveal direction="up">
            <Card className="relative overflow-hidden bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 p-12 lg:p-20 text-center border-none">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
                  {t('smartFactory.futureHeading')}
                </h2>
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                  {t('smartFactory.futureText')}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button 
                    size="lg" 
                    className="text-lg px-8 bg-white text-orange-600 hover:bg-white/90 font-semibold"
                  >
                    {t('common.learnMore')}
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
