...
export default function AiSocPage() {
  ...
  const features = [
    {
      icon: Brain,
      title: t('products.aiSoc.features.ueba.title'),
      description: t('products.aiSoc.features.ueba.description')
    },
    {
      icon: AlertTriangle,
      title: t('products.aiSoc.features.threatDetection.title'),
      description: t('products.aiSoc.features.threatDetection.description')
    },
    {
      icon: Activity,
      title: t('products.aiSoc.features.automation.title'),
      description: t('products.aiSoc.features.automation.description')
    },
    {
      icon: Eye,
      title: t('products.aiSoc.features.monitoring.title'),
      description: t('products.aiSoc.features.monitoring.description')
    }
  ]

  const benefits = [
    t('products.aiSoc.benefits.item1'),
    t('products.aiSoc.benefits.item2'),
    t('products.aiSoc.benefits.item3'),
    t('products.aiSoc.benefits.item4')
  ]
  ...
  return (
    <>
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-xl text-white/90 mb-8 leading-relaxed">
                  {t('products.aiSoc.subtitle')}
                </p>
                
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    size="lg" 
                    className="bg-white text-blue-600 hover:bg-white/90 font-semibold text-lg"
                  >
                    {t('common.learnMore')}
          ...
          <ScrollReveal direction="up">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                {t('products.aiSoc.features.description')}
              </p>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  {t('products.aiSoc.benefits.description')}
                </p>
              ...
              <Card className="p-8 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border-2 border-blue-200 dark:border-blue-800">
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">{t('products.aiSoc.stats.threats')}</div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">{t('products.aiSoc.stats.responseTime')}</div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-background rounded-lg">
                    <div>
                      <div className="text-sm text-muted-foreground">{t('products.aiSoc.stats.accuracy')}</div>
      ...
      <Section spacing="xl" background="gradient">
        <div className="container-responsive">
          <ScrollReveal direction="up">
            <Card className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-cyan-600 to-blue-700 p-12 lg:p-20 text-center border-none">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
                  {t('products.aiSoc.cta.heading')}
                </h2>
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                  {t('products.aiSoc.cta.description')}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button 
                    size="lg" 
                    className="text-lg px-8 bg-white text-blue-600 hover:bg-white/90 font-semibold"
                  >
                    {t('common.learnMore')}
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
